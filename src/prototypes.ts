...
export type CircuitConditionConnector = {
...
export type CustomTooltipField = {
...
export type ScriptedTechnologyTrigger = {
  icon?: FileName;
  icon_size?: SpriteSizeType;
  icons?: IconData[];
...
export interface RawData {
  ...
  'mod-data': Record<string, ModData>;
